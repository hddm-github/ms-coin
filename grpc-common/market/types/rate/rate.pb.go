...
func (x *RateRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RateRes) ProtoMessage() {}

func (x *RateRes) ProtoReflect() protoreflect.Message {
	mi := &file_rate_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RateRes.ProtoReflect.Descriptor instead.
func (*RateRes) Descriptor() ([]byte, []int) {
	return file_rate_proto_rawDescGZIP(), []int{1}
}

func (x *RateRes) GetRate() float64 {
	if x != nil {
		return x.Rate
	}
	return 0
...
const file_rate_proto_rawDesc = "" +
	...
	"\aRateRes\x12\x12\n" +
	"\x04rate\x18\x01 \x01(\x01R\x04rate27\n" +
	"\fExchangeRate\x12'\n" +
	"\ausdRate\x12\r.rate.RateReq\x1a\r.rate.RateResB\bZ\x06./rateb\x06proto3"
