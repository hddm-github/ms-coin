...
const (
	ExchangeRate_UsdRate_FullMethodName = "/rate.ExchangeRate/usdRate"
)
...
func (c *exchangeRateClient) UsdRate(ctx context.Context, in *RateReq, opts ...grpc.CallOption) (*RateRes, error) {
	...
	out := new(RateRes)
	err := c.cc.Invoke(ctx, ExchangeRate_UsdRate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedExchangeRateServer must be embedded to have
...
func (UnimplementedExchangeRateServer) UsdRate(context.Context, *RateReq) (*RateRes, error) {
	return nil, status.Error(codes.Unimplemented, "method UsdRate not implemented")
}
func (UnimplementedExchangeRateServer) mustEmbedUnimplementedExchangeRateServer() {}
func (UnimplementedExchangeRateServer) testEmbeddedByValue()                      {}
...
func RegisterExchangeRateServer(s grpc.ServiceRegistrar, srv ExchangeRateServer) {
	// If the following call panics, it indicates UnimplementedExchangeRateServer was
...
func _ExchangeRate_UsdRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExchangeRate_UsdRate_FullMethodName,
	}
